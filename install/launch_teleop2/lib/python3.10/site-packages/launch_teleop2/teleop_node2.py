...
class TeleopNode2(Node):
    def __init__(self):
        super().__init__('teleop_node2')

        # Configurar el cliente MQTT
        self.mqtt_client = mqtt.Client()
        self.mqtt_client.connect("192.168.8.116", 1883, 60)  # Cambia "localhost" por la IP de tu broker MQTT
    ...
    def teleop_cmd_callback(self, msg):
        ...
        self.mqtt_client.publish("robot3/move", command)

def main(args=None):
    rclpy.init(args=args)
    teleop_node = TeleopNode2()
